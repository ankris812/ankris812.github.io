...
global_variables() {
    ...
    # Blog title
    global_title="Zeus Ricote"
    # The typical subtitle for each blog
    global_description=" "
    # The public base URL for this blog
    global_url="https://ankris812.github.io"

    # Your name
    global_author="Zeus Ricote"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url=""
    # Your email
    global_email="zricote@gmail.com"
